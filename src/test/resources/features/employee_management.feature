Feature: Employee Management
  ...
  Scenario: TC-401 Add a new employee
    ...
    And I enter password on employee "password123"
    And I enter password confirmation "password123"
    And I click the Save button on employee
  ...
  Scenario: TC-402 Edit an existing employee
    ...
    And I enter email on employee "john.doe.updated@example.com"
    And I enter password on employee "newpassword123"
    And I click the Save button on employee
    Then I should be redirected to the employee management page from the employee management page
  ...
  Scenario: TC-403 Delete an employee
    ...
    And I click the Confirm Delete button on employee
